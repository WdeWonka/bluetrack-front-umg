...
import { Phone, MapPin, Calendar, User } from "iconoir-react";

import customerService from "../services/customer.service";

interface SeeCustomerModalProps {
  isOpen: boolean;
  onOpenChange: (open: boolean) => void;
  customerId: number | null;
}

export function SeeCustomerModal({
  isOpen,
  onOpenChange,
  customerId,
}: SeeCustomerModalProps) {
          ...
          <>
            ...
            >
              ...
              <Avatar
                ...
                fallback={<User className="w-15 h-15" />}
              />
            </ModalHeader>
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center gap-5 pt-15">
                  ...
                  <h2 className="text-2xl font-semibold text-gray-900 text-center">
                    {capitalizeName(customer.nombre)}
                  </h2>
