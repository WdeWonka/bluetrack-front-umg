...
import { Search, NavArrowDown, ShareIos, Import, Garage } from "iconoir-react";
...
import { EditWarehouseModal } from "./editWarehousesModal";
import { SeeWarehouseModal } from "./seeWarehouseModal";
          ...
          <div className="flex justify-center items-center">
            <Tooltip closeDelay={0} content="Ver">
              <Button
                ...
                onPress={() => {
                  setSelectedWarehouseId(user.id);
                  onSeeModalOpen();
                }}
              >
                <EyeIcon />
          ...
          emptyContent={
            error ? (
              ...
              <div className="flex flex-col items-center justify-center py-10 text-gray-500 font-medium">
                ...
                No se encontró ningún almacén con &quot;{filterValue}&quot;.
              </div>
            ) : (
